# Set the webhook URL
$dc = "https://discord.com/api/webhooks/1275636071421448254/yfVS5vYWNKMHnPvEKgRnB95EZ84MXzfoVxoY5ytgNLW6k_DKx3tCmP6nMvR22G-p6uZW"  # Replace with your actual webhook URL

# Check if the URL needs to be shortened (optional)
if ($dc -and $dc.Ln -ne 121) {
